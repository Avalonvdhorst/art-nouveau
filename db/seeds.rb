...
art1 = Art.create!(name: "Pink in the sky", description: "Modern work from Pawel Cerwinsky. Bring colour into your living room", location: "Barcelona, Spain", price_per_week: 45, height: 225, width: 140, user: user1, artist: "Pawel Cerwinsky", photo: "https://images.unsplash.com/photo-1578598491752-1df4a1c57439?ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80")
art2 = Art.create!(name: "Purple Haze", description: "Another great piece from Pawel Cerwinsky. Purple burst of colour to bring any space to life.", location: "Barcelona, Spain", price_per_week: 65, height: 180, width: 110, user: user1, artist: "Pawel Cerwinsky", photo: "https://images.unsplash.com/photo-1576180525792-82cdc0e2b29e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80")
...
art3 = Art.create!(name: "Ocean depths", description: "Infinite blues rising to the surface. Dream away at this masterpiece.", location: "Lisbon, Portugal", price_per_week: 40, height: 149, width: 225, user: user2, artist: "Danny Ferlonstad", photo: "https://images.unsplash.com/photo-1515405295579-ba7b45403062?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=80")
art4 = Art.create!(name: "Texture in blue", description: "The artist tried to capture the texture of water smashing into the shore. Experimental piece", location: "Lisbon, Portugal", price_per_week: 85, height: 70, width: 40, user: user2, artist: "Danny Ferlonstad", photo: "https://images.unsplash.com/photo-1420442442888-15c96323ec3c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1567&q=80")
