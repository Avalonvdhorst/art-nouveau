...
art1 = Art.create!(name: "Pink in the sky", description: "Modern work from Pawel Cerwinsky. Bring colour into your living room", location: "Barcelona, Spain", paint_type: "oil on canvas", price_per_week: 45, height: 225, width: 140, user: user1, artist: "Pawel Cerwinsky")
...
art2 = Art.create!(name: "Purple Haze", description: "Another great piece from Pawel Cerwinsky. Purple burst of colour to bring any space to life.", location: "Barcelona, Spain", paint_type: "oil on canvas", price_per_week: 65, height: 180, width: 110, user: user1, artist: "Pawel Cerwinsky")
...
art3 = Art.create!(name: "Ocean depths", description: "Infinite blues rising to the surface. Dream away at this masterpiece.", location: "Lisbon, Portugal", paint_type: "oil on canvas", price_per_week: 40, height: 149, width: 225, user: user2, artist: "Danny Ferlonstad")
...
art4 = Art.create!(name: "Texture in blue", description: "The artist tried to capture the texture of water smashing into the shore. Experimental piece", location: "Lisbon, Portugal", paint_type: "oil on canvas", price_per_week: 85, height: 70, width: 40, user: user2, artist: "Danny Ferlonstad" )
